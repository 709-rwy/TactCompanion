...
TACT Companionは、TACTの授業情報、課題、小テスト、お知らせ、授業資料をiPhoneで確認しやすくするための非公式SwiftUIアプリです。
...
TACTCompanionは個人が開発した非公式アプリです。

本アプリは東海国立大学機構、名古屋大学、岐阜大学、その他関連組織によって開発・運営・承認されたものではありません。

本アプリは利用者の利便性向上を目的として提供されており、公式サービスの代替を意図するものではありません。

掲載される情報の正確性・完全性・最新性について保証するものではありません。重要な情報については、必ず東海国立大学機構および各大学の公式サイトをご確認ください。
